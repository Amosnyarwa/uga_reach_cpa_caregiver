...
father_to_hit_his_child_agree <- df_tool_data %>%
  filter((okay_father_to_hit_his_child %in% c("agree", "strongly_agrees") |
           ...
           (okay_parents_hit_child_to_displine %in% c("disagree", "strongly_disagrees", "neither_agree_nor_agree") &
okay_parents_hit_child_to_set_example %in% c("disagree", "strongly_disagrees", "neither_agree_nor_agree"))) %>%
  mutate(i.check.type = "change_response",
...
father_to_hit_his_child_disagree <- df_tool_data %>%
  filter((okay_father_to_hit_his_child %in% c("disagree", "strongly_disagrees", "neither_agree_nor_agree") |
            okay_mother_to_hit_her_child %in% c("disagree", "strongly_disagrees", "neither_agree_nor_agree")) &
